...
BOT_TOKEN = environ.get('BOT_TOKEN', "7656651082:AAE65UHVxElQV_muVktu5MPiUGw1GnSermE")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002874527675'))
DUMP_CHANNEL = int(os.environ.get('DUMP_CHANNEL', '-1002883423757'))
INSTA_CHANNEL = int(environ.get('INSTA_CHANNEL', '-1002527891441'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002538914329') # give your force subscribe channel id here else leave it blank
...
INDEX_REQ_CHANNEL = int(environ.get('-1002603042037', LOG_CHANNEL))
...
MSG_ALRT = environ.get('MSG_ALRT', 'Sʜᴀʀᴇ & Sᴜᴘᴘᴏʀᴛ Us ♥️ ')
