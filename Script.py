...
Exᴀᴍᴘʟᴇ : Uɴᴄʜᴀʀᴛᴇᴅ Oʀ Uɴᴄʜᴀʀᴛᴇᴅ 𝟸𝟶𝟸𝟸 Oʀ Uɴᴄʜᴀʀᴛᴇᴅ Eɴ
...
Aᴠᴀɪʟᴀʙʟᴇ Cᴏᴍᴍᴀɴᴅs :
• /gfilter - <code>Tᴏ Cʀᴇᴀᴛᴇ A Gʟᴏʙᴀʟ Fɪʟᴛᴇʀ</code>
• /gfilters - <code>Tᴏ Vɪᴇᴡ Aʟʟ Gʟᴏʙᴀʟ Fɪʟᴛᴇʀs</code>
• /delg - <code>Tᴏ Dᴇʟᴇᴛᴇ A Pᴀʀᴛɪᴄᴜʟᴀʀ Gʟᴏʙᴀʟ Fɪʟᴛᴇʀ</code>
• /delallg - <code>Tᴏ Dᴇʟᴇᴛᴇ Aʟʟ Gʟᴏʙᴀʟ Fɪʟᴛᴇʀꜱ</code>"""
    
    FILE_STORE_TXT = """
<b>Fɪʟᴇ Sᴛᴏʀᴇ Is Tʜᴇ Fᴇᴀᴛᴜʀᴇ Wʜɪᴄʜ Wɪʟʟ Cʀᴇᴀᴛᴇ A Sʜᴀʀᴇᴀʙʟᴇ Lɪɴᴋ Oғ A Sɪɴɢʟᴇ Oʀ Mᴜʟᴛɪᴘʟᴇ Fɪʟᴇs</b>

Aᴠᴀɪʟᴀʙʟᴇ Cᴏᴍᴍᴀɴᴅs :
• /batch - <code>Tᴏ Cʀᴇᴀᴛᴇ A Bᴀᴛᴄʜ Lɪɴᴋ Oғ Mᴜʟᴛɪᴘʟᴇ Fɪʟᴇs</code>
• /link - <code>Tᴏ Cʀᴇᴀᴛᴇ A Sɪɴɢʟᴇ Fɪʟᴇ Sᴛᴏʀᴇ Lɪɴᴋ</code>
• /pbatch - <code>Jᴜꜱᴛ Lɪᴋᴇ /batch, Bᴜᴛ Tʜᴇ Fɪʟᴇꜱ Wɪʟʟ Bᴇ Sᴇɴᴅ Wɪᴛʜ Fᴏʀᴡᴀʀᴅ Rᴇꜱᴛʀɪᴄᴛɪᴏɴꜱ</code>
• /plink - <code>Jᴜꜱᴛ Lɪᴋᴇ /link, Bᴜᴛ Tʜᴇ Fɪʟᴇ Wɪʟʟ Bᴇ Sᴇɴᴅ Wɪᴛʜ Fᴏʀᴡᴀʀᴅ Rᴇꜱᴛʀɪᴄᴛɪᴏɴ</code>"""

    SONG_TXT = """<b>Sᴏɴɢ Dᴏᴡɴʟᴏᴀᴅ Mᴏᴅᴜʟᴇ</b> 
      
 <b>Sᴏɴɢ Dᴏᴡɴʟᴏᴀᴅ Mᴏᴅᴜʟᴇ, Fᴏʀ Tʜᴏꜱᴇ Wʜᴏ Lᴏᴠᴇ Mᴜꜱɪᴄ. Yᴏᴜ Cᴀɴ Uꜱᴇ Tʜɪꜱ Fᴇᴀᴛᴜᴇ Fᴏʀ Dᴏᴡɴʟᴏᴀᴅ Aɴʏ Sᴏɴɢ Wɪᴛʜ Sᴜᴩᴇʀ Fᴀꜱᴛ Sᴩᴇᴇᴅ. Wᴏʀᴋꜱ Bᴏᴛ Aɴᴅ Gʀᴏᴜᴩꜱ Oɴʟʏ...</b> 
  
 <b>Cᴏᴍᴍᴀɴᴅs</b> :<b> 𝄟⃝.  /song Sᴏɴɢ Nᴀᴍᴇ</b></b>""" 
  
    YTDL_TXT = """<b>Hᴇʟᴩ Yᴏᴜ Tᴏ Dᴏᴡɴʟᴏᴀᴅ Vɪᴅᴇᴏ Fʀᴏᴍ Yᴏᴜᴛᴜʙᴇ. 
  
 Uꜱᴀɢᴇ : Yᴏᴜ Cᴀɴ Dᴏᴡɴʟᴏᴀᴅ Aɴʏ Vɪᴅᴇᴏ Fʀᴏᴍ Yᴏᴜᴛᴜʙᴇ 
  
 Hᴏᴡ Tᴏ Uꜱᴇ : Tʏᴩᴇ - /video Oʀ /mp4 
  
 Exᴀᴍᴩʟᴇ :<code>/mp4 https://youtu.be/example...</code></b>""" 
  
    TTS_TXT = """<b>Tᴛꜱ 🎤 Mᴏᴅᴜʟᴇ : Tʀᴀɴꜱʟᴀᴛᴇ Tᴇxᴛ Tᴏ Sᴩᴇᴇᴄʜ 
 ...
 Cᴏᴍᴍᴀɴᴅꜱ Aɴᴅ Uꜱᴀɢᴇ : /tr - Tᴏ Tʀᴀɴꜱʟᴀᴛᴇʀ Tᴇxᴛꜱ Tᴏ A Sᴩᴇᴄɪꜰᴄ Lᴀɴɢᴜᴀɢᴇ 
  
 Nᴏᴛᴇ : Wʜɪʟᴇ Uꜱɪɴɢ /tr Yᴏᴜ Sʜᴏᴜʟᴅ Sᴩᴇᴄɪꜰʏ Tʜᴇ Lᴀɴɢᴜᴀɢᴇ Cᴏᴅᴇ 
 ...
 • Hɪ = Hɪɴᴅɪ</b>""" 
    ...
    TELE_TXT = """<b>Hᴇʟᴘ : Tᴇʟᴇɢʀᴀᴘʜ Dᴏ Aꜱ Yᴏᴜ Wɪꜱʜ Wɪᴛʜ Tᴇʟᴇɢʀᴀ.Pʜ Mᴏᴅᴜʟᴇ !!! 
  
 Uꜱᴀɢᴇ : /telegraph - Sᴇɴᴅ Mᴇ Pɪᴄᴛᴜʀᴇ Oʀ Vɪᴅᴇ Uɴᴅᴇʀ (𝟻 Mʙ) 
  
 Nᴏᴛᴇ : 
 Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Iꜱ Aᴠᴀɪʟᴀʙʟᴇ Iɴ Gᴏᴜᴘꜱ Aɴᴅ Pᴍꜱ 
 Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Cᴀɴ Bᴇ Uꜱᴇᴅ Bʏ Eᴠᴇʀʏᴏɴᴇ</b>""" 
  
    CORONA_TXT = """<b>Hᴇʟᴩ : Cᴏᴠɪᴅ 
  
 Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Hᴇʟᴩꜱ Yᴏᴜ Tᴏ Kɴᴏᴡ Dᴀɪʟʏ Iɴꜰᴏʀᴍᴀᴛɪᴏɴ Aʙᴏᴜᴛ Cᴏᴠɪᴅ 
  
 Cᴏᴍᴍᴀɴᴅꜱ Aɴᴅ Uꜱᴀɢᴇ : 
  
 /covid - Uꜱᴇ Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Wɪᴛʜ Yᴏᴜʀ Cᴏᴜɴᴛʀʏ Nᴀᴍᴇ Tᴏ Gᴇᴛ Cᴏᴠɪᴅᴇ Iɴꜰᴏʀᴍᴀᴛɪᴏɴ 
 Exᴀᴍᴩʟᴇ :<code>/covid 𝖨𝗇𝖽𝗂𝖺</code> 
